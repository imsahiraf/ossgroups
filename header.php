...
<head>
		<meta charset="utf-8">
	<title>OSS Groups and Company</title>
	<meta name="author" content="Web IT Services">
		...
		<div class="tt-header-holder">
			<div class="tt-col tt-col__wide">
				<div class="h-info-list">
					<address class="tt-visible-xl">B1701, Landmark Tower, Morachi Wadi, Naigaon, Dadar(E), Mumbai - 400014</address>
					<address class="tt-visible-xl"><span class="tt-title">E-mail us:</span> <a href="mailto:info@ossgroups.com">info@ossgroups.com</a></address>
					<address>
						<i class="icon">
